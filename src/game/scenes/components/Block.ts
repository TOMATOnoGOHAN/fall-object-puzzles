...
// prettier-ignore
export enum BlockType { I = 'I', O = 'O', T = 'T', L = 'L', J = 'J', S = 'S', Z = 'Z' }
...
export const BLOCK: Record<BlockType, BlockDefinition> = {
  ...
  J: { shape: [[0, 1], [0, 1], [1, 1]], color: Colors.BLOCKS.J },
  S: { shape: [[0, 1, 1], [1, 1, 0]], color: Colors.BLOCKS.S },
  Z: { shape: [[1, 1, 0], [0, 1, 1]], color: Colors.BLOCKS.Z }
}
